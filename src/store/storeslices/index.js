  ...
  reducers: {
    apidatatype: (state, action) => {
      ...
      Suggested: (state, action) => {
       ...
       else{state.suggesteddata=[...state.suggesteddata, clickedItem]; 
       }
      },
      ...
      newAdded: (state, action) => {
       ...
       else{state.newitem=[...state.newitem, clickedItem]; 
       }
      },
      sugestManually: (state, action) => {
       ...
       else{state.manualdata=[...state.manualdata, clickedItem]; 
       }
      },
      sugestions: (state, action) => {
       ...
       else{state.suggestions=[...state.suggestions, clickedItem]; 
       }
      },
...
export const { apidatatype,filterData,searchData,Logindetail,Suggested,newAdded,sugestManually,sugestions} = ApidataSlice.actions
